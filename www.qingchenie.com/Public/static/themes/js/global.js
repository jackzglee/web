...
$(function(){
	...
	$("<link>").attr({ rel: "stylesheet",type: "text/css",href: "../css/ld.css"/*tpa=http://www.fengbangleasing.com/Public/static/themes/css/ld.css*/}).appendTo("head");
...
//	sideBarPos('.side-bar',1250,45);			//	侧边栏定位调用
	...
	var ww = $(window).width();
	if(ww<750){
		$(".tools .search-box").css({"width":ww});
		$(".x-header .tele a").text("");
	}
	...
	// 移动端二维码收取
	if( $(window).width() < 750 ){
		$(".share-box .icon-wchat").click(function(){
			$(this).addClass("click");
		})
		
		$(".share-item .code").click(function(e){
			e.stopPropagation();
			$(".share-box .icon-wchat").removeClass("click");
		})
	}
...
function loadMap(){
	...
	script.src = "../../../../../api.map.baidu.com/api-v=3.0&ak=3c3f2a3587ab7a1d7ac9f2b326d66ec8&callback=createMap.js"/*tpa=http://api.map.baidu.com/api?v=3.0&ak=3c3f2a3587ab7a1d7ac9f2b326d66ec8&callback=createMap*/;
...
//	setMapStyle();		  //	设置地图风格	http://lbsyun.baidu.com/custom/list.htm
	...
	//		var myIcon = new BMap.Icon("../../../../../lbsyun.baidu.com/jsdemo/img/fox.gif"/*tpa=http://lbsyun.baidu.com/jsdemo/img/fox.gif*/, new BMap.Size(300,157));		//	自定义标注图标
